...
import com.example.bolmalre.global.auth.filter.CustomLogoutFilter;
import com.example.bolmalre.global.auth.filter.LoginFilter;
import com.example.bolmalre.global.auth.infrastructure.redis.RefreshRepository;
import com.example.bolmalre.global.auth.jwt.JWTFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
                ...
                .cors(corsCustomizer -> corsCustomizer.configurationSource(new CorsConfigurationSource() {
                    ...
                    public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                        ...
                        configuration.setAllowedOrigins(Arrays.asList(
                                ...
                                "https://bolmal-dev-front.vercel.app/"
                        ));
        ...
        http.authorizeHttpRequests((auth)->auth
                ...
                .requestMatchers("/concerts/search/names").permitAll()
