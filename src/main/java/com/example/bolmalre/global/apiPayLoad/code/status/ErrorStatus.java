package com.example.bolmalre.global.apiPayLoad.code.status;


import com.example.bolmalre.global.apiPayLoad.code.BaseErrorCode;
import com.example.bolmalre.global.apiPayLoad.code.ErrorReasonDTO;
...
public enum ErrorStatus implements BaseErrorCode {
    ...
    CONCERT_DUPLICATE(HttpStatus.BAD_REQUEST,"CONCERT4003","이미 존재하는 콘서트입니다"),
