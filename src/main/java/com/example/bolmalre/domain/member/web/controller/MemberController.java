package com.example.bolmalre.domain.member.web.controller;

import com.example.bolmalre.global.apiPayLoad.ApiResponse;
import com.example.bolmalre.domain.member.web.dto.*;
import com.example.bolmalre.domain.member.web.port.MemberService;
...
public class MemberController {
    ...
    public ApiResponse<String> validPassword(@AuthenticationPrincipal UserDetails userDetails,
                                             @Valid @RequestBody MemberPasswordValidDTO.MemberPasswordValidRequestDTO request) {
